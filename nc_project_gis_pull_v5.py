...
APP_NAME = "NC Project GIS Pull v5"
...
PARCEL_URL = "https://services.nconemap.gov/secure/rest/services/NC1Map_Parcels/FeatureServer/1/query"
...
def add_statewide(msp,xmin,ymin,xmax,ymax,opts,labels,logger):
    ...
    if opts.get("parcels"):
        ...
        gj=query_url(PARCEL_URL,xmin,ymin,xmax,ymax)
...
class App(tk.Tk):
    ...
    def build(self):
        p={"padx":8,"pady":6}
        ttk.Label(self,text="NC Project GIS Pull v5",font=("Segoe UI",18,"bold")).pack(anchor="w",padx=16,pady=(16,8))
    ...
    def browse(self):
        p=filedialog.asksaveasfilename(title="Save MSD DXF",defaultextension=".dxf",initialfile="NC_Project_GIS_Export_v5.dxf",filetypes=[("DXF","*.dxf")])
